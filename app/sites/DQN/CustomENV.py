...
from sites.DQN.UsefulFunc import OutdoorTemp, People, Price, Desire
from gym import Env
...
class ShowerEnv(Env):
    ...
    def __init__(self, FromHour,ToHour, W, desire):
        ...
        # Set start temp
        self.state = np.array([12, Desire(0,self.desire,self.FromHour,self.ToHour),OutdoorTemp(0),Price(0),People(0,self.FromHour,self.ToHour),0])
